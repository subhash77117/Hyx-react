const Desktop = () => {
  return (
    <div className="relative bg-whitesmoke w-full overflow-hidden flex flex-col items-center justify-start pt-[27px] pb-[280px] pr-[27px] pl-5 box-border gap-[64px] tracking-[normal] mq450:gap-[16px] mq725:gap-[32px]">
      <header className="w-[1247px] flex flex-row items-center justify-between gap-[20px] max-w-full text-left text-lg text-darkslategray-100 font-med mq975:w-[722px]">
        <img
        ...
        />
        <div className="flex flex-row items-center justify-start gap-[40px] max-w-full mq725:gap-[20px] mq975:hidden">
      ...
      <main className="w-[1257px] flex flex-col items-start justify-start py-0 pr-1 pl-0 box-border gap-[81px] max-w-full mq450:gap-[20px] mq725:gap-[40px]">
        <section className="w-[988px] flex flex-col items-start justify-start py-0 pr-[3px] pl-0 box-border gap-[64px] max-w-full text-center text-lg text-dimgray font-med mq725:gap-[16px] mq1000:gap-[32px]">
          <div className="flex flex-row items-center justify-start [row-gap:20px] max-w-full mq725:flex-wrap">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[56px] max-w-full text-[32px] font-montserrat mq725:gap-[28px]">
            <h2 className="m-0 relative text-inherit font-bold font-inherit text-transparent !bg-clip-text [background:linear-gradient(180deg,_#06286e,_#164ec0)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] inline-block max-w-full mq450:text-lgi mq975:text-[26px]">
              Relations and Functions ( Mathematics )
            </h2>
            <div className="self-stretch flex flex-row items-start justify-end max-w-full text-left text-xl font-med">
              <div className="w-[712px] flex flex-col items-center justify-start gap-[32px] max-w-full mq725:gap-[16px]">
                <div className="w-[554px] flex flex-row items-start justify-start py-0 pr-2 pl-0 box-border max-w-full shrink-0">
                  <div className="flex-1 flex flex-row items-start justify-between gap-[20px] max-w-full mq725:flex-wrap">
                ...
                <div className="self-stretch flex flex-row items-center justify-start relative shrink-0 text-center text-[38.3px] text-white font-lato">
                  <div className="w-0 flex flex-col items-start justify-end py-0 px-0 box-border">
                    <div className="w-[378px] overflow-hidden flex flex-row items-center justify-end max-w-[Infinity%] shrink-0">
                        ...
                        <div className="w-[712px] flex flex-row items-center justify-center relative [transform:_rotate(180deg)] max-w-[Infinity%] shrink-0">
                          ...
                          <div className="flex-1 rounded-[42.51px] [background:linear-gradient(222.94deg,_#071844,_#071844_3.95%,_#2d87b6_82.51%,_#2d87b6)] overflow-hidden flex flex-row items-start justify-between pt-[34px] pb-[173px] pr-[35px] pl-[34px] box-border gap-[20px] max-w-full mq450:flex-wrap mq450:pt-[22px] mq450:pb-28 mq450:box-border">
                            ...
                            <div className="w-[133px] h-[186px] flex flex-col items-start justify-start pt-[140px] px-0 pb-0 box-border">
                              <b className="self-stretch flex-1 relative tracking-[0.02em] mq450:text-[23px] mq975:text-[31px]">
                                5x + 12
                              </b>
                            </div>
                            <img
        ...
        <section className="self-stretch flex flex-row items-center justify-between min-h-[154px] gap-[20px] text-left text-[12.4px] text-dimgray font-med mq725:flex-wrap">
        ...
        <section className="w-[848px] flex flex-col items-start justify-start gap-[48px] max-w-full text-left text-[48px] text-gray font-med mq450:gap-[24px]">
          <h1 className="m-0 relative text-inherit tracking-[0.01em] font-bold font-inherit text-transparent !bg-clip-text [background:linear-gradient(180deg,_#06286e,_#164ec0)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] mq450:text-[29px] mq975:text-[38px]">
            FAQ
          </h1>
